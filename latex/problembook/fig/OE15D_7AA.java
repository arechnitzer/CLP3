...
public class OE15D_7AA extends Template {

     static {templateClass = new OE15D_7AA() ; }
...
//             fPolygon3d(xlist, ylist, zlist, 4, FILLED) ; }
          ...
          canvas.append( new fPsWrite(Red+"\n")) ;
               fCurve(new circ3d(proj,   0,0,-r, r,0,0, 0,r,0),
                      -90,90,OPEN)  ;
//               fTeXlabel3d(0,r+3,0, "cl", "$x^2+y^2=1$") ;
