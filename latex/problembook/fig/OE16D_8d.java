...
public class OE16D_8d extends Template {

     static {templateClass = new OE16D_8d() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(xm+0.1,0,0, "tc", "$x$") ;
               ...
               double ZM =3.0 ;
               fEnv("lineWidth", 1.0) ;
               fCurve(new interSectY(proj,0), 0,Math.sqrt(ZM),OPEN)  ;
               fCurve(new interSectY(proj,YM),0,Math.sqrt(ZM),OPEN)  ;
               fLine3d(Math.sqrt(ZM),0,ZM,  Math.sqrt(ZM),YM,ZM) ;
