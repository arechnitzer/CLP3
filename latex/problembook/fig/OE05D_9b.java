...
public class OE05D_9b extends Template {

     static {templateClass = new OE05D_9b() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(xm+0.1,0,0, "tc", "$x$") ;
               ...
               fDisk3d(0, 2, 0, rr, rr*aspect) ;
               fTeXlabel3d(0, 2, 0.1, "bl", "$\\scriptstyle (0, 2, 0)$") ;
               fDisk3d(0, 0, 2, rr, rr*aspect) ;
               fTeXlabel3d(0, 0.1, 2.1, "bl", "$\\scriptstyle (0, 0, 2)$") ;
               fDisk3d(2, 0, 0, rr, rr*aspect) ;
               fTeXlabel3d(2, 0.1, -0.1, "tl", "$\\scriptstyle (2, 0, 0)$") ;
               fDisk3d(0, -1, 3, rr, rr*aspect) ;
               fTeXlabel3d(0, -1.1, 3.1, "bc", "$\\scriptstyle (0, -1, 3)$") ;
               fDisk3d(3, -1, 0, rr, rr*aspect) ;
               fTeXlabel3d(3, -1, -0.1, "tc", "$\\scriptstyle (3, -1, 0)$") ;


               fTeXlabel3d(0, 0.55, 1.5, "bl", "$x+y+z=2$") ;
