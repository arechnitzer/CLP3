...
public class OE06D_6a2 extends Template {

     static {templateClass = new OE06D_6a2() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "OE06D_6a2" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 6.5*0.5 ;    
          ysize = 6.5*0.5 ;  
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(1.9,2.2,0, "tc", "$2x+y+4z=4$") ;

          double r = 0.08 ;
          fEnv("psFillGray", 0.0) ;
          fDisk3d(0,0,1, r,r) ;
          fTeXlabel3d(0, -0.05, 1.05, "br", "$\\scriptstyle (0,0,1)$") ;
          fDisk3d(0,4,0, r,r) ;
          fTeXlabel3d(0.05, 4, -0.1, "tc", "$\\scriptstyle (0,4,0)$") ;
          fDisk3d(2,0,0, r,r) ;
