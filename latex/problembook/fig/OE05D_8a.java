...
public class OE05D_8a extends Template {

     static {templateClass = new OE05D_8a() ; }
...
//          fEnv("useColorPs", "true") ;
          ...
          String Blue = "1 1 0 0 setcmykcolor  " ;
               ...
               fTeXlabel3d(0,2*r+3,r, "cl", "$x^2+y^2=2y$") ;
...
//               fLine3d(0,0, 0,    2*r,0,2*r) ;
               ...
               fCurve(new circ3d(proj,   0,r, 2*r, r,0,0, 0,r,0),
                      -90,90,OPEN)  ;
               fCurve(new circ3d(proj,   0,r, 0  , r,0,0, 0,r,0),
                      -90,90,OPEN)  ;
               fLine3d(0,0, 2*r,  0,2*r,2*r) ;
               fLine3d(0,0, 0,  0,0,2*r) ;
               fLine3d(0,2*r, 0,  0,2*r,2*r) ;
               fLine3d(r,r, 0,  r,r,2*r) ;
               ...
               fDisk3d(r, r, 0, rr, rr*aspect) ;
               fTeXlabel3d(r, r, -2, "tc", "$(1, 1, 0)$") ;
               fDisk3d(0, r, 2*r, rr, rr*aspect) ;
               fTeXlabel3d(0, r, 2*r+2, "bc", "$(0, 1, 2)$") ;
