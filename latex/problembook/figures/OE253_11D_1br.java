...
public class OE253_11D_1br extends Template {

     static {templateClass = new OE253_11D_1br() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "OE253_11D_1br" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0*0.6 ;    
          ysize = 2.0*0.8 ;  
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fCurve(new hyperbola3d(al, 0.5,   0,0,0, s,c,0, 0,0,1, 1,1),
                 1,3,OPEN) ;
