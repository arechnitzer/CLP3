...
public class spherPhiUp extends Template {

     static {templateClass = new spherPhiUp() ; }
...
//          double z = 75 ;
          ...
          fCurve(new circ3d(proj,   0,0,0, 0,0,r, 0,r,0),  0,35,OPEN)  ;
          ...
          fEnv("lineWidth", 1.5) ;
          fCurve(new circ3d(proj,   0,0,z, Rx,0,0, 0,Ry,0),  0,360,OPEN)  ;
          double th = -10 ; double thRad = th*Math.PI/180 ;
          double c = Math.cos(thRad) ;   double s = Math.sin(thRad) ;
          fLine3d(0,0,0, Rx*s,Rx*c,z) ;
          th = -25 ; thRad = th*Math.PI/180 ;
          c = Math.cos(thRad) ;   s = Math.sin(thRad) ;
          fLine3d(0,0,0, -Rx*s,-Rx*c,z) ;

          fTeXlabel3d(0, 10 ,40,  "tc", "$\\frac{\\pi}{4}$") ;          
          fTeXlabel3d(0, 65 ,50,  "tc", "$\\varphi=\\frac{\\pi}{4}$") ;          
