...
public class polar2AA extends Template {

     static {templateClass = new polar2AA() ; }

     public void setup() {
          filePrefix = "polar2AA" ;  // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fEllipticalArc(0, 0, R, R, 0, 270, OPEN) ;
          fTeXlabel(-0.65*R, 0.85*R, "br", "$\\tfrac{3\\pi}{2}$") ;
          ...
          fTeXlabel(x1+0.15,y1, "cl", "$r=-1,\\ \\theta=\\tfrac{3\\pi}{2}$") ;
          ...
          fTeXlabel(x2-0.1,y2, "cr", "$r=1,\\ \\theta=\\tfrac{3\\pi}{2}$") ;
