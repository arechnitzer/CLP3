...
public class spherPhiDn extends Template {

     static {templateClass = new spherPhiDn() ; }
...
//          double z = 75 ;
          ...
          fEnv("psFillGray", 0.8) ;
//          fCurve(new circ3d(proj,   0,0,z, Rx,0,0, 0,Ry,0),  0,360,FILLED)  ;
          ...
          fCurve(new circ3d(proj,   0,0,0, 0,0,r, 0,r,0),  0,128,OPEN)  ;
          ...
          fEnv("lineWidth", 1.5) ;
          fCurve(new circ3d(proj,   0,0,z, Rx,0,0, 0,Ry,0),  -75,120,OPEN)  ;
          canvas.append( new fPsWrite("[2 2] 0.0 setdash\n")) ;
          fCurve(new circ3d(proj,   0,0,z, Rx,0,0, 0,Ry,0),  120,360-75,OPEN)  ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;


          double th = -28 ; double thRad = th*Math.PI/180 ;
          double c = Math.cos(thRad) ;   double s = Math.sin(thRad) ;
          fLine3d(0,0,0, Rx*s,Rx*c,z) ;
          th = -18 ; thRad = th*Math.PI/180 ;
          c = Math.cos(thRad) ;   s = Math.sin(thRad) ;
          fLine3d(0,0,0, -Rx*s,-Rx*c,z) ;

          fTeXlabel3d(0, 12 ,10,  "bl", "$\\frac{3\\pi}{4}$") ;          
          fTeXlabel3d(0, 47 ,-45,  "bl", "$\\varphi=\\frac{3\\pi}{4}$") ;          
