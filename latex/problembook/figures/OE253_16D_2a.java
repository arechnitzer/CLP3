...
public class OE253_16D_2a extends Template {

     static {templateClass = new OE253_16D_2a() ; }

     public void setup() {
          filePrefix = "OE253_16D_2a" ;    
          outputPsFile = true ;
          outputLblFile = true ;
...
//          fDisk(0,sq12, 2,2, CLOSED) ;
          ...
          fEnv("lineWidth",0.5) ;
          canvas.append( new fPsWrite("[2 2] 1.0 setdash\n")) ;
          fLine(-2,sq12/2, 1,sq12/2) ;
          canvas.append( new fPsWrite("[  ] 0 setdash\n")) ;
          fTeXlabel(-2.1,sq12/2, "rc", "$z=\\sqrt{3}$") ;
          ...
          fEllipticalArc(0,0, 2,2, 60,120, OPEN) ;
