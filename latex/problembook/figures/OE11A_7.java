...
public class OE11A_7 extends Template {

     static {templateClass = new OE11A_7() ; }
...
//          fEnv("useColorPs", "true") ;
          ...
          canvas.append( new fPsWrite(Red+"\n")) ;
               ...
               fDisk3d(0,2,2, rr, rr) ;
               fTeXlabel3d(0,2.04,2.04, "bl", "$(0,2,2)$") ;

               fDisk3d(2,0,2, rr, rr) ;
               fTeXlabel3d(2,-0.1,1.95, "cr", "$(2,0,2)$") ;

               fTeXlabel3d(0,1,2.1, "bl", "$z=2$") ;
               fTeXlabel3d(0,1.02,1, "tl", "$z=x+y$") ;
