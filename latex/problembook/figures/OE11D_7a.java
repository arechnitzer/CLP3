...
public class OE11D_7a extends Template {

     static {templateClass = new OE11D_7a() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fEnv("lineWidth", 0.5) ;
//  for      static double[] fwd = {1, 0.5, 1.0} ; 
//          double xt =0.35 ;
//          double yt =1.0 ;
//          double zt = 1.0 ;
//  for      static double[] fwd = {1, 0.3, 0.5} ; 
          double xt =0.0 ;
          double yt =1.0 ; double ytl = 0.19 ;
          double zt = 1.0 ; double ztb = 0.19 ;
          fLine3d(0,0,0, 0,ytl,0) ;
          fLine3d(0,yt,0, 0,ym,0) ;
          fLine3d(xt,0,0, xm,0,0) ;
          fLine3d(0,0,0, 0,0,ztb) ;
          ...
          fTeXlabel3d(xm,0,-0.04, "tc", "$x$") ;
               ...
               fTeXlabel3d(0,0.55,0.55, "cl", "$y+z=1$") ;
