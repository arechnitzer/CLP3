...
public class cylP1 extends Template {

     static {templateClass = new cylP1() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fCurve(new circ3d(proj,   0,0,0, 20,0,0, 0,20,0),  0,45,OPEN)  ;
          fTeXlabel3d(25,10,0, "tc", "$\\scriptstyle \\frac{\\pi}{4}$") ;
          fLine3d(r/sq2,r/sq2,0, r/sq2,r/sq2,r)  ;
          fLine3d(0,0,r, r/sq2,r/sq2,r)  ;
          
          fLine3d(0,0,0, r/sq2,r/sq2,0) ;
          fEnv("useColorPs", "true") ;
          fEnv("psFillColor", Blue) ;
          fDisk3d(r/sq2,r/sq2,0, ep,ep, FILLED) ;
          fDisk3d(r/sq2,r/sq2,r, ep,ep, FILLED) ;
          fDisk3d(r,0,0, ep,ep, FILLED) ;
          fDisk3d(0,r,0, ep,ep, FILLED) ;
          fDisk3d(0,0,r, ep,ep, FILLED) ;

          fEnv("useColorPs", "false") ;
          fEnv("lineWidth", 0.5) ;
          canvas.append( new fPsWrite(Black+"\n")) ;
          fArrow3d(r,-50,0,  r,-3,0) ;
          fTeXlabel3d(r,-51,0, "cr", "$\\scriptstyle r=1,\\ \\theta=0,\\ z=0$") ; 
          fTeXlabel3d(0.5*r,-1,0, "cr", "$\\scriptstyle 1$") ; 

          fArrow3d(r/sq2,r/sq2,-30,  r/sq2+3,r/sq2,0) ;
          fTeXlabel3d(r/sq2,r/sq2,-33, "tc", 
                   "$\\scriptstyle r=1,\\ \\theta=\\frac{\\pi}{4},\\ z=0$") ; 
          fTeXlabel3d(0.5*r/sq2,0.5*r/sq2,0, "bl", "$\\scriptstyle 1$") ; 

          fArrow3d(0,100,-30,  0,r+2,-3) ;
          fTeXlabel3d(0,80,-32, "tl", 
                   "$\\scriptstyle r=1,\\ \\theta=\\frac{\\pi}{2},\\ z=0$") ; 
          fTeXlabel3d(0,0.75*r,2, "bc", "$\\scriptstyle 1$") ; 

          fArrow3d(r/sq2,80,r,  r/sq2,r/sq2+2,r) ;
          fTeXlabel3d(r/sq2,82,r, "cl", 
                   "$\\scriptstyle r=1,\\ \\theta=\\frac{\\pi}{4},\\ z=1$") ; 
          fTeXlabel3d(r/sq2,r/sq2, 0.5*r, "cr", "$\\scriptstyle 1$") ; 

          fArrow3d(0,-50,r,  0,-3,r) ;
          fTeXlabel3d(0,-51,r, "cr", "$\\scriptstyle r=0,\\ \\theta=\\pi,\\ z=1$") ; 
          fTeXlabel3d(0,-1,0.5*r, "cr", "$\\scriptstyle 1$") ; 
