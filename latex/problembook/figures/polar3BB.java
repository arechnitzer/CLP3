...
public class polar3BB extends Template {

     static {templateClass = new polar3BB() ; }

     public void setup() {
          filePrefix = "polar3BB" ;  // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
