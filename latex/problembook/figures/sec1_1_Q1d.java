...
public class sec1_1_Q1d extends Template {

     static {templateClass = new sec1_1_Q1d() ; }

     public void setup() {
          filePrefix = "sec1_1_Q1d" ; // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 1.5 ;      // in inches
