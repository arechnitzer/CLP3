...
public class OE15D_7B extends Template {

     static {templateClass = new OE15D_7B() ; }
...
//          fEnv("useColorPs", "true") ;
          ...
          double yy = 0.5*r ;
          double xx = Math.sqrt(r*r-yy*yy) ;
          double th = Math.asin(z/r)*180/Math.PI ;
          fCurve(new circ3d(proj,   0,0,z , r),th,90,FILLED)  ;
          {  double[] xlist = {0,   0,  xx, x} ;
             double[] ylist = {z,   r,  yy, z} ;
...
//             fPolygon3d(xlist, ylist, zlist, 4, FILLED) ; }
          ...
          canvas.append( new fPsWrite(Red+"\n")) ;
               fCurve(new circ3d(proj,   0,0,-r, r,0,0, 0,r,0),
                      -90,90,OPEN)  ;
               fTeXlabel3d(0,r+3,-0.6*r, "cl", "$x^2+y^2=1$") ;
...
//               fTeXlabel3d(X,-r-2,-r, "br", "$y=z$") ;
          ...
          fEnv("psFillGray", 0.0) ;
               fDisk3d(0,-r,-r, rr, rr) ;
               fTeXlabel3d(0,-r-4,-r, "cr", "$(0,-1,-1)$") ;
               fDisk3d(0, r, r, rr, rr) ;
               fTeXlabel3d(0, r+4, r, "cl", "$(0, 1, 1)$") ;
               fDisk3d(0,z,z, rr, rr) ;
               fTeXlabel3d(0,z-4,z, "br", "$(0,z,z)$") ;
               fDisk3d(0, r, z, rr, rr) ;
               fTeXlabel3d(0, r+4, z, "cl", "$(0, 1, z)$") ;
               fDisk3d(Math.sqrt(r*r-z*z), z, z, rr, rr) ;
          canvas.append( new fPsWrite("0.0 setgray\n")) ;
          fEnv("lineWidth", 0.5) ;
          fEnv("headHalfWidth", 2*1.2) ;
          fEnv("headLength", 6*1.2) ;
               fArrow3d(0,-r,-0.5*r, Math.sqrt(r*r-z*z), z-2, z+1) ;
               fTeXlabel3d(0,-r-1,-0.5*r, "br", "$(\\sqrt{1-z^2}, z, z)$") ;
