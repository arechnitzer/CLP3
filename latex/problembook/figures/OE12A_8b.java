...
public class OE12A_8b extends Template {

     static {templateClass = new OE12A_8b() ; }
...
//               double YM =3.5 ;
               double ZM = 1 ;
               fEnv("lineWidth", 1.0) ;
               fCurve(new interSect(proj,0), 0,Math.sqrt(ZM),OPEN)  ;
               fCurve(new interSect(proj,1), 0,Math.sqrt(ZM),OPEN)  ;
               fLine3d(0,Math.sqrt(ZM),ZM,  1,Math.sqrt(ZM),ZM) ;
               fLine3d(0,0,0,  1,0,0) ;

               fTeXlabel3d(0,0.7,0.5, "br", "$z=y^2$") ;
