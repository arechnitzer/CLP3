...
public class partialTotal extends Template {

     static {templateClass = new partialTotal() ; }
...
//            fLine3d(0,0,0, r*xh,r*yh,0) ;
          ...
          phi = phi2 ;
            ...
            fCurve(new circ3d(proj,   0,0,r*zv, r*xv),0,90,OPEN)  ;
          psi = phi1 ;
            xv = Math.sin(psi*Math.PI/180);
            zv = Math.cos(psi*Math.PI/180);
            x1 = r*xv ;
            z1 = r*zv ;
            fCurve(new circ3d(proj, r*xv,0,0, 0,0,r*zv, 0,r*zv,0),0,90,OPEN)  ;
            fLine3d(r*xv,0,0, r*xv,0,r*zv) ;
            fLine3d(r*xv,0,0, r*xv,r*zv,0) ;
            fDisk3d(r*xv,0,r*zv, rr, rr, FILLED) ;
          psi = phi2 ;
            xv = Math.sin(psi*Math.PI/180);
            zv = Math.cos(psi*Math.PI/180);
            x2 = r*xv ;
