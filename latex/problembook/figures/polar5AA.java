...
public class polar5AA extends Template {

     static {templateClass = new polar5AA() ; }

     public void setup() {
          filePrefix = "polar5AA" ;  // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(-x1-0.2,-y1+0.5,"rc","$r=\\sqrt{2},\\ \\theta=\\frac{5\\pi}{4}$");
