...
public class cylinder2 extends Template {

     static {templateClass = new cylinder2() ; }

     public void setup() {
          filePrefix = "cylinder2" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0*0.7 ;    
          ysize = 2.7*0.7 ;  
...
//          double x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel(1,60, "lb", "$\\varphi$") ;
          fTeXlabel(0,-35, "tl", "$\\varphi<\\tan^{-1}\\frac{a}{h}$") ;
          fTeXlabel(30,h+30, "bl", "$\\rho=\\frac{h}{\\cos\\varphi}$") ;
