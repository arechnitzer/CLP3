...
public class OE14D_9d extends Template {

     static {templateClass = new OE14D_9d() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(xm,0,-0.2, "tc", "$x$") ;
               ...
               fCurve(new interSect(proj,3), 0,Math.sqrt(ZM),OPEN)  ;
               fLine3d(0,Math.sqrt(ZM),ZM,  3,Math.sqrt(ZM),ZM) ;
               fLine3d(0,0,0,  3,0,0) ;

               fTeXlabel3d(1.5,Math.sqrt(ZM),ZM, "bl", "$z=y^2$") ;
