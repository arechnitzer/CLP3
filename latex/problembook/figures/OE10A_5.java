...
public class OE10A_5 extends Template {
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(xmin-0.03,1, "cr", "$x^2+y^2=1$") ;

          fLine(0,0, xmax,xmax/2) ;
          fTeXlabel(xmax+0.03,xmax/2, "cl", "$y=x/2$") ;
          
          fLine(0,0, ymax/2,ymax) ;
          fTeXlabel(ymax/2+0.03,ymax, "cl", "$y=2x$") ;
...
//          fTeXlabel(xmin-0.03,y1, "cr", "$y=1/\\sqrt{5}$") ;
          ...
          double thmRad = 0.5*th1Rad+0.5*th2Rad ;
          double xm = 0.7*Math.cos(thmRad) ; double ym = 0.7*Math.sin(thmRad) ;
          fTeXlabel(xm, ym, "cc",  "$G$") ;
