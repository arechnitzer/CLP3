...
public class coneSphere extends Template {

     static {templateClass = new coneSphere() ; }

     public void setup() {
          filePrefix = "coneSphere" ;    
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 1.6*1.1 ;      // in inches
          ysize = 1.4*1.1 ;   // in inches. 
          xmin = -0.8 ;
          xmax = 0.8 ;
          ymin = -0.2 ;
          ymax =  1.2 ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(0.05, 0.22, "lb", "$\\frac{\\pi}{4}$") ;
...
//          canvas.append( new fPsWrite("[  ] 0 setdash\n")) ;
          ...
          fTeXlabel(xmin+0.03, 0.54, "tr", "$x^2+y^2+z^2=a^2$") ;
          fTeXlabel(0.38, 0.4, "tl", "$z=\\sqrt{x^2+y^2}$") ;
