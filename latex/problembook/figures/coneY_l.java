...
public class coneY_l extends Template {

     static {templateClass = new coneY_l() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          double y0 = 0 ; double X = 0 ; double Y = 0 ; double Z = 0 ;
          ...
          fLine3d(0,0,0,  0,f*y0,f*(Z+0.1)) ;

          fEnv("psFillGray", 0.8) ;
          fCurve(new circ3d(proj,   0,y0,0, X,0,0, 0,0,Z),
                 0,90,FILLED) ;
          {double[] xlist = { 0,  0, 0.7*X,  X} ;
           double[] ylist = {y0, y0,    y0, y0} ;
           double[] zlist = { 0,  Z, 0.7*Z,  0} ;
           fPolygon3d(xlist,ylist, zlist, 4, FILLED) ;}

          fCurve(new circ3d(proj,   0,y0,0, X,0,0, 0,0,Z),
                 0,90,OPEN) ;

          fLine3d(0,y0,0,  0,y0,Z) ;
          fLine3d(0,y0,0,  X,y0,0) ;
          fLine3d(0,0,0,  X,y0,0) ;
          double y1 = 2 ;
          fLine3d(0,y1,0, 0,y0,0) ;
