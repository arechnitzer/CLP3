...
//          double x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel(5,60, "lb", "$\\varphi$") ;
          fTeXlabel(0,-40, "tl", "$\\varphi=\\tan^{-1}\\frac{a}{h}$") ;
          fTeXlabel(a/2,h+3, "cb", "$a$") ;
          fTeXlabel(-1,0.6*h, "rc", "$h$") ;
