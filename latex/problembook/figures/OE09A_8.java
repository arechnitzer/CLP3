...
public class OE09A_8 extends Template {

     static {templateClass = new OE09A_8() ; }
...
//          fEnv("useColorPs", "true") ;
          ...
          canvas.append( new fPsWrite(Red+"\n")) ;
               ...
               fDisk3d(0,0,3, rr, rr) ;
               fTeXlabel3d(0,0.1,3.00, "cl", "$(0,0,3)$") ;

               fDisk3d(-1,0,0, rr, rr) ;
               fTeXlabel3d(-1, 0.1,  0.02, "tl", "$(-1,0,0)$") ;

               fDisk3d(0,-2,0, rr, rr) ;
               fTeXlabel3d(0,-2.02,-0.02, "tr", "$(0,-2,0)$") ;
