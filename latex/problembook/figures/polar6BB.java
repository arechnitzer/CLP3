...
public class polar6BB extends Template {

     static {templateClass = new polar6BB() ; }

     public void setup() {
          filePrefix = "polar6BB" ;  // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(x3,y3-0.15, "tc", "$r=2,\\ \\theta=\\pi$") ;
          fDisk(-x3,y3, rr, rr, FILLED) ;
