...
public class OE05D_9c extends Template {

     static {templateClass = new OE05D_9c() ; }
...
//               fLine3d(3,-1,0, 0,-1,3) ;
          ...
          canvas.append( new fPsWrite("[  ] 0 setdash\n")) ;
               ...
               fDisk3d(0, 0, 1, rr, rr*aspect) ;
               fTeXlabel3d(0, -0.05, 1.1, "br", "$\\scriptstyle (0, 0, 1)$") ;
               fDisk3d(1, 1, 0, rr, rr*aspect) ;
               fTeXlabel3d(1, 1, -0.1, "tl", "$\\scriptstyle (1, 1, 0)$") ;
               fDisk3d(2, 0, 0, rr, rr*aspect) ;
               fTeXlabel3d(2, 0, -0.1, "tl", "$\\scriptstyle (2, 0, 0)$") ;
               fDisk3d(3, -1, 0, rr, rr*aspect) ;
               fTeXlabel3d(3, -1, -0.1, "tr", "$\\scriptstyle (3, -1, 0)$") ;
               fDisk3d(1, 0, 1, rr, rr*aspect) ;
               fArrow3d(0, 0.5, 1.5,  1,0.04,1.06) ;
               fTeXlabel3d(0, 0.55, 1.5, "cl", "$\\scriptstyle (1, 0, 1)$") ;
