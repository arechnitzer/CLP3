...
public class OE11D_8f extends Template {

     static {templateClass = new OE11D_8f() ; }

     public void setup() {
          filePrefix = "OE11D_8f" ;    
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 8.5*0.3 ;      // in inches
          ysize = 7.5*0.3 ;   // in inches. 
          xmin = -4.25 ;
          xmax = 4.25 ;
          ymin = -4.25 ;
          ymax =  3.25 ;
...
//           }   
         ...
         fDisk(0,0, r,r, FILLED) ;   
          fTeXlabel(0.25, 0.05, "lb", "$\\scriptstyle (0,0,0)$") ;
