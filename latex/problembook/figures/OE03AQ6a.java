...
public class OE03AQ6a extends Template {

     static {templateClass = new OE03AQ6a() ; }

     public void setup() {
          filePrefix = "OE03AQ6a" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          double y = c*(1+x/a) ;
          fLine(x,0, x,y) ;
          fTeXlabel( x-1,y, "cr", "$y=c(1+x/a)$") ;
          x = 0.3*b ;
          y = c*(1-x/b) ;
          fLine(x,0, x,y) ;
          fTeXlabel( x+2,y, "cl", "$y=c(1-x/b)$") ;
          fEnv("psGray", 0) ;
