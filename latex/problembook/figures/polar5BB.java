...
public class polar5BB extends Template {

     static {templateClass = new polar5BB() ; }

     public void setup() {
          filePrefix = "polar5BB" ;  // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(-x1-0.2,-y1+0.5,"rc","$r=-\\sqrt{2},\\ \\theta=\\frac{\\pi}{4}$");
