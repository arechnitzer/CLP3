...
public class OE16D_8c extends Template {

     static {templateClass = new OE16D_8c() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(xm+0.1,0,0, "tc", "$x$") ;
               ...
               fLine3d(XM,0,3, XM,2,1) ;
               fLine3d(XM,2,1, 0,2,1) ;
               fLine3d(0,2,0, 0,2,1) ;
               fLine3d(XM,2,0, XM,2,1) ;
               fLine3d(XM,2,0, 0,2,0) ;
               fLine3d(XM,2,0, XM,0,0) ;
               fLine3d(XM,0,0, XM,0,3) ;


               fTeXlabel3d(0,1.1,2, "bl", "$y+z=3$") ;
               fTeXlabel3d(XM/2,2.1,0, "tl", "$y=2$") ;
