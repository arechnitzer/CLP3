...
public class OE11D_7c extends Template {

     static {templateClass = new OE11D_7c() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fEnv("lineWidth", 0.5) ;
//          double yt =0.5 ;  //for  fwd = {1, 0.5, 1.0} ;
//          double yt =0.7 ;  //for  fwd = {1, 0.3, 1.0} ;
          double yt =1.0 ;  //for  fwd = {1, 0.3, 1.0} ;
...
//          fEnv("useColorPs", "true") ;
          ...
          canvas.append( new fPsWrite(Red+"\n")) ;
               double XM =1.0 ;
               fCurve(new parCylinder(proj,0), 0,XM,OPEN)  ;
//               fCurve(new parCylinder(proj,1), 0,XM,OPEN)  ;
//               fLine3d(XM,XM*XM,1,  XM,XM*XM,0) ;
               fLine3d(0,0,0,  0,0,1) ;
               fTeXlabel3d(0.7*XM,0.49*XM*XM-0.05,0, "tr", "$y=x^2$") ;

               fLine3d(0,1,0, 0,0,1) ;
//               fLine3d(XM,1,0, XM,0,1) ;
//               fLine3d(0,0,1, XM,0,1) ;
               fLine3d(0,1,0, XM,1,0) ;

               fCurve(new interSectZ(proj), 0,XM,OPEN)  ;
               fDisk3d(1,1,0, 0.02, 0.02) ;


               fTeXlabel3d(0,0.85,0.25, "cl", "$z=1-y$") ;
               fTeXlabel3d(0.5,1.05,0, "cl", "$y=1$, $z=0$") ;
               fTeXlabel3d(1.02,1.02,0, "tl", "$(1,1,0)$") ;
...
class parCylinder implements S2V {

     double[][] proj = { {1, 0, 0},   { 0,  1, 0}   };
     double Z = 0 ;

   public parCylinder(double[][] proj, double Z) {
        this.proj = proj ;
        this.Z = Z ;
   }
...
class interSectZ implements S2V {

     double[][] proj = { {1, 0, 0},   { 0,  1, 0}   };

   public interSectZ(double[][] proj) {
        this.proj = proj ;
   }
