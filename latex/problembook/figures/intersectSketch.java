...
public class intersectSketch extends Template {

     static {templateClass = new intersectSketch() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "intersectSketch" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 3.0 ;    
          ysize = 3.0 ;  
...
//          fEnv("psFillGray", 0.0) ;
          ...
          fLine3d(0,0,z, 0,y,0) ;
          fDisk3d(0, y, 0, rx,ry) ;
          fTeXlabel3d(0,y,-0.3, "tc", "$(0,8,0)$") ;
          fDisk3d( 0,0, z, rx,ry) ;
          fTeXlabel3d(0,-0.4,z, "cr", "$(0,0,4)$") ;
     }
