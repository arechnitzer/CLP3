...
public class OE12A_8c extends Template {

     static {templateClass = new OE12A_8c() ; }
...
//          fEnv("useColorPs", "true") ;
          ...
          canvas.append( new fPsWrite(Red+"\n")) ;
               ...
               fCurve(new interSect(proj,0), 0,1,OPEN)  ;
               fCurve(new interSectZ(proj), 0,1,OPEN)  ;

               fDisk3d(0,1,1, 0.02, 0.02) ;
               fTeXlabel3d(0,1.02,1.02, "bl", "$(0,1,1)$") ;

               fDisk3d(1,0,0, 0.02, 0.02) ;
               fTeXlabel3d(1,-.02,0, "tr", "$(1,0,0)$") ;

               fTeXlabel3d(0.5,0.53,0, "tl", "$y=1-x$") ;
               fTeXlabel3d(0,0.72,0.5, "br", "$z=y^2$") ;
...
class interSect implements S2V {
   ...
   public interSect(double[][] proj, double X) {
        this.proj = proj ;
        this.X = X ;
   }
