...
public class polar4BB extends Template {

     static {templateClass = new polar4BB() ; }

     public void setup() {
          filePrefix = "polar4BB" ;  // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(x1-0.2,y1-0.45,"lc","$r=-\\sqrt{2},\\ \\theta=\\frac{5\\pi}{4}$");
          ...
          fTeXlabel(-x1+0.2,-y1+0.45,"rc", "$r=\\sqrt{2},\\ \\theta=\\frac{5\\pi}{4}$") ;
