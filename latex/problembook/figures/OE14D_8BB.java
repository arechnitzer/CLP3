...
public class OE14D_8BB extends Template {

     static {templateClass = new OE14D_8BB() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(0,0,zm+1, "cb", "$z$") ;
          fTeXlabel3d(0,ym+1,0, "cl", "$y$") ;
...
//          fEnv("useColorPs", "true") ;
          ...
          canvas.append( new fPsWrite(Red+"\n")) ;
               ...
               double cos = Math.cos(thRad) ;
               double sin = Math.sin(thRad) ;
               fCurve(new circ3d(proj,   0,0,0, -r*cos,-r*sin,0, 0,0,r),
                        0,90,OPEN)  ;
               fLine3d(0,0,0, -r*cos, -r*sin, 0) ;
               ...
               fCurve(new circ3d(proj,   0,0,0, -r*cos,-r*sin,0, 0,0,r),
                        0,90,OPEN)  ;
               fLine3d(0,0,0, -r*cos, -r*sin, 0) ;
               fTeXlabel3d(-r,1,0.5*r, "cl", "$x^2+y^2+z^2=a^2$") ;
               fLine3d(0,0,0, -r,0,0) ;
               fLine3d(0,0,0, 0,-r,0) ;
               fLine3d(0,0,0, 0,0, r) ;
