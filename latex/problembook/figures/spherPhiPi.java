...
public class spherPhiPi extends Template {

     static {templateClass = new spherPhiPi() ; }
...
//          double z = R*Math.cos(phi) ;
          ...
          fEnv("lineWidth", 1.5) ;
          fLine3d(0,0,0, 0,0,-80) ;

          fTeXlabel3d(0, 2 ,-40,  "cl", "$\\varphi=\\pi$") ;          
