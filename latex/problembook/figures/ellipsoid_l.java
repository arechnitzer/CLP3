...
public class ellipsoid_l extends Template {

     static {templateClass = new ellipsoid_l() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          double y0 = 0 ; double X = 3 ; double Y = Math.sqrt(12) ; double Z = 03 ;
          ...
          fCurve(new circ3d(proj,   0,0,0, X,0,0, 0,Y,0),
                 0,90,OPEN) ;
          fCurve(new circ3d(proj,   0,0,0, 0,0,Z, 0,Y,0),
                 0,90,OPEN) ;
          ...
          fTeXlabel3d(X,-0.2,-0.2, "tl", "$(3,0,0)$") ;
          fDisk3d(0,Y,0, r,r*aspect, FILLED) ;
          fTeXlabel3d(0,Y+0.4,-0.3, "tr", "$(0,\\sqrt{12},0)$") ;
          fDisk3d(0,0,Z, r,r*aspect, FILLED) ;
          fTeXlabel3d(0,0.1,Z+0.1, "bl", "$(0,0,3)$") ;
     }
