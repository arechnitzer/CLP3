...
public class shiftSphere extends Template {

     static {templateClass = new shiftSphere() ; }
...
//          fTeXlabel3d(xm,-0.05,-0.05, "cr", "$x$") ;
          ...
          fEnv("lineWidth", 1.5) ;
          double th = -15 ; double thRad = th*Math.PI/180 ;
          double c = Math.cos(thRad) ;  double s = Math.sin(thRad) ;

          fCurve(new circ3d(proj,   0,0,0, X,0,0, 0,0,Z),
                 -90,90,OPEN) ;
          fCurve(new circ3d(proj,   0,0,0, X,0,0, 0,Y,0),
                 -80,95,OPEN) ;
          fCurve(new circ3d(proj,   0,0,0, 0,0,Z, Y*s,Y*c,0),
                 0,360,OPEN) ;
          ...
          fDisk3d(X,0,0, r,r*aspect, FILLED) ;
          fDisk3d(s*Y,c*Y,0, r,r*aspect, FILLED) ;
          fTeXlabel3d(s*Y,c*Y+0.2,-0.1, "tl", "$\\frac{1}{2}(-4,b+2r_b,-9)$") ;
          fDisk3d(0,0,Z, r,r*aspect, FILLED) ;
          fTeXlabel3d(0,0.1,Z+0.2, "bl", "$\\frac{1}{2}(-4,b,-9+2r_b)$") ;

          fEnv("lineWidth", 0.5) ;
          canvas.append( new fPsWrite(Black+"\n")) ;
          fEnv("headHalfWidth", 2*1.2) ;
          fEnv("headLength", 6*1.2) ;
          fArrow3d(1,-4,2, 0,-0.2,0.2) ;
          fTeXlabel3d(1,-4.2,2, "br", "$\\frac{1}{2}(-4,b,-9)$") ;
          fArrow3d(1,-4,-2, X,-0.2,-0.2) ;
          fTeXlabel3d(1,-4.2,-2, "tr", "$\\frac{1}{2}(-4+2r_b,b,-9)$") ;
