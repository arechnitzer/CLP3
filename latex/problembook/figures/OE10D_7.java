...
public class OE10D_7 extends Template {

     static {templateClass = new OE10D_7() ; }
...
//          fEnv("useColorPs", "true") ;
          ...
          canvas.append( new fPsWrite(Red+"\n")) ;
               ...
               fDisk3d(0,0,1, rr, rr) ;
               fTeXlabel3d(0,0.02,1.02, "bl", "$(0,0,1)$") ;

               fDisk3d(1,0,0, rr, rr) ;
               fTeXlabel3d(1,-0.02,0.02, "br", "$(1,0,0)$") ;

               fDisk3d(0,1,0, rr, rr) ;
               fTeXlabel3d(0,1.02,0.02, "bl", "$(0,1,0)$") ;

               fTeXlabel3d(0,0.54,0.55, "cl", "$z=1-x-y$") ;
