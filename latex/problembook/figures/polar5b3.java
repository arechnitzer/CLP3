...
public class polar5b3 extends Template {

     static {templateClass = new polar5b3() ; }
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fEnv("psFillGray", 0.6) ;
          fEllipticalArc(0,0, r1, r1, 0,90, WEDGE+FILLED) ;
          fEnv("psFillGray", 0.3) ;
          fEllipticalArc(0,0, r1, r1, th,th+dth, WEDGE+FILLED) ;
          fEnv("psFillGray", 0.9) ;
          fEllipticalArc(0,0, r2, r2, 0,90, WEDGE+FILLED) ;
          fEnv("lineWidth", 0.5) ;
