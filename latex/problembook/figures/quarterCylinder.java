...
public class quarterCylinder extends Template {

     static {templateClass = new quarterCylinder() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          th = 0 ;
          for ( int i=0; i <= nth ; i++ ) {
               xh = r*Math.cos(th*Math.PI/180);
               yh = r*Math.sin(th*Math.PI/180);
               fLine3d(xh,yh,0,  xh,yh,Z)  ;
               th += dth ;
          } 
