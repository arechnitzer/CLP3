...
public class inscSpher extends Template {

     static {templateClass = new inscSpher() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "inscSpher" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 3.0 ;    
          ysize = 3.0 ;  
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          double r = 50 ;
          double a = 30 ;
          double h = Math.sqrt(r*r-2*a*a)-10 ;
          double xm = 80 ;
          double ym = 65 ;
          double zm = 60 ;
          ...
          fCurve(new circ3d(al, 0.5,   0,0,0, r,0,0, 0,r,0),
                 -112,150,OPEN)  ;
          fCurve(new circ3d(al, 0.5,   0,0,0, 0,r,0, 0,0,r),
                 0,180,OPEN)  ;
