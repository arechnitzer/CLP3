...
public class OE03AQ5b extends Template {

     static {templateClass = new OE03AQ5b() ; }

     public void setup() {
          filePrefix = "OE03AQ5b" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(0.65, 0.5, "lc", "$y=x$") ;
          fTeXlabel(0.65, 1.5, "lc", "$y=2-x$") ;
