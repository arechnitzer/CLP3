...
public class OE13D_8b1 extends Template {

     static {templateClass = new OE13D_8b1() ; }
...
//          fEnv("useColorPs", "true") ;
          ...
          {  double[] xlist = {1.2,  -1.2, -1.2, 1.2} ;
             double[] ylist = {0,   0, 1, 1} ;
             double[] zlist = {0,   0, 1, 1} ;
             fPolygon3d(xlist, ylist, zlist, 4, CLOSED) ; }
          fTeXlabel3d(-1.2,1.05,1, "cl", "$z=y$") ;
