...
public class OE12A_8aa extends Template {

     static {templateClass = new OE12A_8aa() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(xm+0.05,0,0, "tl", "$x$") ;
               ...
               fEnv("lineWidth", 1.0) ;
               fLine3d(1,0,0, 0,1,0) ;
               fLine3d(1,0,0, 1,0,ZM) ;
               fLine3d(0,1,0, 0,1,ZM) ;
               fLine3d(1,0,ZM, 0,1,ZM) ;
               fLine3d(0,0,ZM, 1,0,ZM) ;
               fLine3d(0,0,ZM, 0,1,ZM) ;


               fTeXlabel3d(0.5,0.53,0, "tl", "$x+y=1$") ;
