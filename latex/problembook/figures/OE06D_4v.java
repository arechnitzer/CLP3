...
public class OE06D_4v extends Template {

     static {templateClass = new OE06D_4v() ; }
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(1.5, 3, "br", "$y=2x$") ;
          fTeXlabel(0.3, 4, "tl", "$y=1/x$") ;

          canvas.append( new fPsWrite("[2 2] 1.0 setdash\n")) ;
          fLine(1,2,  1,-0.25) ;
          fTeXlabel(1, -0.25, "ct", "$x=1$") ;
