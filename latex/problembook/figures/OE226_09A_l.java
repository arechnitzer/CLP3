...
public class OE226_09A_l extends Template {

     static {templateClass = new OE226_09A_l() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "OE226_09A_l" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 1.6 ;    
          ysize = 2.0 ;  
...
//                 0,90,OPEN) ;
          ...
          z0=3 ; 
          double XM = 0.5*Math.sqrt(1+z0*z0) ;
          double YM = Math.sqrt(1+z0*z0) ;
          fLine3d(0,0,z0, 0,YM,z0) ;
          fLine3d(0,0,z0, XM,0,z0) ;

          z0=0 ; 
          XM = 0.5*Math.sqrt(1+z0*z0) ;
          YM = Math.sqrt(1+z0*z0) ;
          fLine3d(0,0,z0, 0,YM,z0) ;
          fLine3d(0,0,z0, XM,0,z0) ;
     }
