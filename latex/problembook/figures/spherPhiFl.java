...
public class spherPhiFl extends Template {

     static {templateClass = new spherPhiFl() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fEnv("psFillGray", 0.8) ;
         {double[] xlist = {X,  X, Xm, Xm} ;
          double[] ylist = {Y, Ym, Ym,  Y} ;
          ...
          fTeXlabel3d(0,ym+7,0, "cl", "$y$") ;
          fTeXlabel3d(xm,-2,-2, "tr", "$x$") ;
          ...
          fTeXlabel3d(Xm, 30 ,3,  "bc", "$\\varphi=\\frac{\\pi}{2}$") ;          
