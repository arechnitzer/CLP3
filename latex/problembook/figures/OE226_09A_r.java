...
public class OE226_09A_r extends Template {

     static {templateClass = new OE226_09A_r() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "OE226_09A_r" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0*0.6 ;    
          ysize = 2.0*0.8 ;  
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fCurve(new hyperbola3d(al, 0.5,   0,0,0, Math.sin(thRad),Math.cos(thRad), 0, 
                                                    0,0,1, 1,1), -3,3,OPEN) ;
          th = 3 ; thRad = th*Math.PI/180 ;
          fCurve(new hyperbola3d(al, 0.5,   0,0,0, Math.sin(thRad),-Math.cos(thRad),0, 
                                                    0,0,1, 1,1), -3,3,OPEN) ;

//          fCurve(new hyperbola3d(al, 0.5,   0,0,0, Math.cos(thRad),Math.sin(thRad),0, 
//                                                     0,0,1, 2,1), -3,3,OPEN) ;
