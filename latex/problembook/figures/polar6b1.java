...
public class polar6b1 extends Template {

     static {templateClass = new polar6b1() ; }
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(ymax+0.03, ymax+0.01, "bl", "$\\theta=\\nicefrac{\\pi}{4}$") ;
...
//          fTeXlabel(2-ymax, ymax+0.02, "bc", "$y=2-x$") ;
          ...
          rr = 0.04 ;
          fEnv("psFillGray", 0.0) ;
          fDisk(1,1, rr,rr, FILLED) ;
          fTeXlabel(1.1,1, "cl", "$(1,1)$") ;
