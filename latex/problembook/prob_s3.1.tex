...
\begin{center}
  (a) \raisebox{-0.5\height}{\includegraphics{fig/domain2a.pdf}}\qquad
  (b) \raisebox{-0.5\height}{\includegraphics{fig/domain2b.pdf}}\qquad
  (c) \raisebox{-0.5\height}{\includegraphics{fig/domain2c.pdf}}            
\end{center}
\begin{center}
  (d) \raisebox{-0.5\height}{\includegraphics{fig/domain2d.pdf}}\qquad
  (e) \raisebox{-0.5\height}{\includegraphics{fig/domain2e.pdf}}\qquad
  (f) \raisebox{-0.5\height}{\includegraphics{fig/domain2f.pdf}}
\end{center}
...
\begin{center}
  (a) \raisebox{-0.5\height}{\includegraphics{fig/domain4a.pdf}} \qquad
  (b) \raisebox{-0.5\height}{\includegraphics{fig/domain4b.pdf}} 
\end{center}
\begin{center}
  (c) \raisebox{-0.5\height}{\includegraphics{fig/domain4c.pdf}}     \end{center}
