...
(b)
\begin{center}
%(i)   \raisebox{-0.5\height}{\includegraphics{fig/level1b.pdf}}
(i)   \raisebox{-0.5\height}{\includegraphics[width=0.33\textwidth, height=0.3\textwidth]{fig/level1b.pdf}}
\quad
%(ii)  \raisebox{-0.5\height}{\includegraphics{fig/level2b.pdf}}
(ii)  \raisebox{-0.5\height}{\includegraphics[width=0.33\textwidth, height=0.3\textwidth]{fig/level2b.pdf}}
\end{center}
\begin{center}
(iii)   \raisebox{-0.5\height}{\includegraphics[width=0.33\textwidth, height=0.3\textwidth]{fig/level3b.pdf}}
%(iii)   \raisebox{-0.5\height}{\includegraphics{fig/level3b.pdf}}
\quad
%(iv)   \raisebox{-0.5\height}{\includegraphics{fig/level4b.pdf}}
(iv)   \raisebox{-0.5\height}{\includegraphics[width=0.33\textwidth, height=0.3\textwidth]{fig/level4b.pdf}}
\end{center}
\end{answer}
...
\renewcommand{\arraystretch}{1.0}
\qquad
\raisebox{-0.5\height}{\includegraphics{fig/OE14D_5.pdf}}
\end{center}
\end{solution}
