...
direction of the gradient of $f$. The unit vector in that direction is
\begin{equation*}
...
\end{itemize}
Since $x(0)=0$ and $y(0)=100$, we have $z'(0)= -0.02(100)y'(0) = -2y'(0)$. So
\begin{align*}
...
vector to the surface $f=2$ at $(1, 0, \pi/2)$. So the specified tangent
plane is
\begin{align*}
