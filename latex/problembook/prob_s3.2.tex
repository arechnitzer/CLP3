...
\begin{center}
    (a)\quad \raisebox{-0.9\height}{\includegraphics{fig/polar5a1.pdf}}\hfil
    (b)\quad \raisebox{-0.9\height}{\includegraphics{fig/polar5b1.pdf}}
\end{center}
\begin{center}
    (c)\quad \raisebox{-0.9\height}{\includegraphics{fig/polar5e1.pdf}}
                                                      \phantom{$y=x$}\hfil
    (d)\quad \raisebox{-0.9\height}{\includegraphics{fig/polar5c1.pdf}}
\end{center}
\end{question}
...
\begin{center}
    (a)\quad 
     \raisebox{-0.9\height}{\includegraphics{fig/polar6a2.pdf}}\hfill
    (b)\quad \raisebox{-0.9\height}{\includegraphics{fig/polar6b2.pdf}}
\end{center}
...
\vadjust{
\begin{center}
     \includegraphics{fig/domain2.pdf}
\end{center}
}%
...
\vadjust{
\begin{center}
     \includegraphics{fig/domainTwoCylinder.pdf}
\end{center}
}%
The solid
