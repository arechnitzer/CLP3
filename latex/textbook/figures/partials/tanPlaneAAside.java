...
public class tanPlaneAAside extends Template {

     static {templateClass = new tanPlaneAAside() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(0,ym,0.5*Z, "cl", "$z=f(x,y_0),\\ y=y_0$") ;
          double XX = 30 ; double ZZ = Z*Math.sqrt(1-XX*XX/(X*X)) ;
          double XXX = 75 ; double ZZZ = Z*Math.sqrt(1-XXX*XXX/(X*X)) ;
          ...
          fArrow3d(0,XX,ZZ,  0,XXX,ZZZ) ;
          double r = 2.0 ;
          fDisk3d(0,XX,ZZ, r, r*aspect) ;
          fTeXlabel3d(0,XX+5,ZZ+5, "bc", "${\\scriptstyle (x_0\\,,\\,y_0\\,,\\,f(x_0,y_0))}$") ;
          fDisk3d(0,XXX,ZZZ, r, r*aspect) ;
          fTeXlabel3d(0,XXX-5,ZZZ+5, "bl", "${\\scriptstyle (x_0+h\\,,\\,y_0\\,,\\,f(x_0+h,y_0))}$") ;
          fDisk3d(0,XX,0, r, r*aspect) ;
          fTeXlabel3d(0,XX,-5, "tc", "${\\scriptstyle (x_0,y_0,0)}$") ;
          fDisk3d(0,XXX,0, r, r*aspect) ;
          fTeXlabel3d(0,XXX,-5, "tc", "${\\scriptstyle (x_0+h,y_0,0)}$") ;
