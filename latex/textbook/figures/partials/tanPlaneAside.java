...
public class tanPlaneAside extends Template {

     static {templateClass = new tanPlaneAside() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(0,XXX-5,ZZZ+5, "bl", "${\\scriptstyle (a+h\\,,\\,b\\,,\\,f(a+h,b))}$") ;
          fDisk3d(0,XX,0, r, r*aspect) ;
          fTeXlabel3d(0,XX,-5, "tc", "${\\scriptstyle (a,b,0)}$") ;
          fDisk3d(0,XXX,0, r, r*aspect) ;
          fTeXlabel3d(0,XXX,-5, "tc", "${\\scriptstyle (a+h,b,0)}$") ;
