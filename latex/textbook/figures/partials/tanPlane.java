...
public class tanPlane extends Template {

     static {templateClass = new tanPlane() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(XB,1,0.6*ZB, "cl", "$x=a$") ;
          ...
          canvas.append( new fPsWrite(Black+"\n")) ;
          fEnv("lineWidth", 0.5) ;
          fDisk3d(XX,Y,ZZ, 1.3, 1.3*aspect) ;
          fArrow3d(XX,2.7*Y,ZZ,  XX, Y ,ZZ) ;
          fTeXlabel3d(XX,2.7*Y+2,ZZ, "cl", "$\\big(a,b,f(a,b)\\big)$") ;
          fDisk3d(XX,Y,0, 1.3, 1.3*aspect) ;
          fArrow3d(XX+20,2.7*Y,0,  XX, Y+1.3 ,0) ;
          fTeXlabel3d(XX+20,2.7*Y+2,0, "cl", "$(a,b,0)$") ;
