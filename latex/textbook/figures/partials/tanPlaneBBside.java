...
public class tanPlaneBBside extends Template {

     static {templateClass = new tanPlaneBBside() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(0,ym,0.3*Z, "cl", "$z=f(x_0,y),\\ x=x_0$") ;
          ...
          fTeXlabel3d(0,XXX-5,ZZZ+5, "bl", "${\\scriptstyle (x_0\\,,\\,y_0+h\\,,\\,f(x_0,y_0+h))}$") ;
          fDisk3d(0,XX,0, r, r*aspect) ;
          fTeXlabel3d(0,XX,-5, "tc", "${\\scriptstyle (x_0,y_0,0)}$") ;
          fDisk3d(0,XXX,0, r, r*aspect) ;
          fTeXlabel3d(0,XXX,-5, "tc", "${\\scriptstyle (x_0,y_0+h,0)}$") ;
