...
public class tanPlaneBside extends Template {

     static {templateClass = new tanPlaneBside() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(0,ym+2,0.3*Z, "cl", "$z=f(a,y),\\ x=a$") ;
          ...
          fTeXlabel3d(0,XX+5,ZZ+5, "bc", "${\\scriptstyle (a\\,,\\,b\\,,\\,f(a,b))}$") ;
          fDisk3d(0,XXX,ZZZ, r, r*aspect) ;
          fTeXlabel3d(0,XXX-5,ZZZ+5, "bl", "${\\scriptstyle (a\\,,\\,b+h\\,,\\,f(a+h,b))}$") ;
          fDisk3d(0,XX,0, r, r*aspect) ;
          fTeXlabel3d(0,XX,-5, "tc", "${\\scriptstyle (a,b,0)}$") ;
          fDisk3d(0,XXX,0, r, r*aspect) ;
          fTeXlabel3d(0,XXX,-5, "tc", "${\\scriptstyle (a,b+h,0)}$") ;
