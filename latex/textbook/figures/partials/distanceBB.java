...
public class distanceBB extends Template {

     static {templateClass = new distanceBB() ; }
...
//                    fTeXlabel3d(0,y2+0.1,z2, "cl", "$(a,b,a^2+b^2)$") ;
          ...
          double y3 = 0.5 ; double z3 = y3*y3 ;
          double y4 = 0.85 ; double z4 = y4*y4 ;
          fDisk3d(0,y3,z3, r,r*aspect,FILLED) ;
          fLine3d(0,y1,0, 0,y3,z3) ;
          fDisk3d(0,y4,z4, r,r*aspect,FILLED) ;
          fLine3d(0,y1,0, 0,y4,z4) ;
