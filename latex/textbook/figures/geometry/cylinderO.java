...
public class cylinderO extends Template {

     static {templateClass = new cylinderO() ; }

     public void setup() {
          filePrefix = "cylinderO" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 3*150/120.0*0.7 ;      
          ysize = 4*180/120*0.7 ;  
          xmin = -60 ;
          xmax = 90 ;
          ymin = -90 ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fEnv("lineWidth", 1) ;
          fEnv("psFillGray", 0.8) ;
          fDisk(s,h,x,x/3.0, FILLED) ;
          String Red = "0 1 1 0 setcmykcolor  " ;
          canvas.append( new fPsWrite(Red+"\n")) ;
          fLine(-x,-h, -x+s,h) ;
          fLine(x,-h, x+s,h) ;
          fDisk(s,h,x,x/3.0, CLOSED) ;
          ...
          fTeXlabel(0, -h-x/3.0-3, "tc", "$x^2+(y-z)^2=1$") ;
