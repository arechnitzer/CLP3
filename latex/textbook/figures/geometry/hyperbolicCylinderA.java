...
public class hyperbolicCylinderA extends Template {

     static {templateClass = new hyperbolicCylinderA() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "hyperbolicCylinderA" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0 ;    
          ysize = 2.0 ;  
