...
public class cylA extends Template {

     static {templateClass = new cylA() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          y = 0 ;
          for ( int i=0; i <= ny ; i++ ) {
               fCurve(new circ3d(proj,   0,y,0, 0,0,r, r,0,0),   0,90,OPEN)  ;
               y += dy ;
          } 
          ...
          fLine3d(r*xv,0,r*zv,  r*xv,Y,r*zv)  ;
               phi += dphi ;
          } 
          fEnv("lineWidth", 1.5) ;
               ...
               fLine3d(r,0,0, r,Y,0) ;
          fEnv("lineWidth", 0.5) ;
          fTeXlabel3d(0,0.5*Y,r+2, "bc", "$F=9$") ;
          ...
          fEnv("lineWidth", 1.5) ;
               ...
               fLine3d(r,0,0, r,Y,0) ;
          fEnv("lineWidth", 0.5) ;
          fTeXlabel3d(0,0.5*Y,r+2, "bc", "$F=4$") ;
          ...
          fEnv("lineWidth", 1.5) ;
               ...
               fLine3d(r,0,0, r,Y,0) ;
          fEnv("lineWidth", 0.5) ;
          fTeXlabel3d(0,0.5*Y,r+2, "bc", "$F=1$") ;
