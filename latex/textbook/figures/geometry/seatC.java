...
public class seatC extends Template {

     static {templateClass = new seatC() ; }
...
//          double X = Math.sqrt(2.0) ; double Y=2.0 ;
          ...
          fCurve(new seatZ(al, 0.5,   4.0 , 0.5),
                 1.7 , 7 ,OPEN) ;
//          fTeXlabel3d(0,4.5,0.6, "br", "$z=1/2$" ) ;


//          fLine3d(0,0,1, xm,0,1) ;
//          fLine3d(0,0,1, 0,ym,1) ;
//          fCurve(new seatZ(al, 0.5,   4.0 , 1),
//                 1, 4 ,OPEN) ;

          fLine3d(0,0,2, xm,0,2) ;
          fLine3d(0,0,2, 0,ym,2) ;
          fCurve(new seatZ(al, 0.5,   4.0 , 2),
                 1/2.3, 5.2 ,OPEN) ;
...
//          fTeXlabel3d(0,4.5,4.1, "br", "$z=4$" ) ;
         ...
         fCurve(new seatX(al, 0.5,   4.0 , 4),
                 1/4.0, 4 ,OPEN) ;
         fTeXlabel3d(3.6,0,3, "cr", "$x=4$" ) ;

         fCurve(new seatY(al, 0.5,   4.0 , 4),
                 1/3.97, 4 ,OPEN) ;
        fTeXlabel3d(0,4.0,3, "cl", "$y=4$" ) ;
