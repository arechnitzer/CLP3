...
public class hyperboloid1sheetD extends Template {

     static {templateClass = new hyperboloid1sheetD() ; }
...
//  General orthogonal projection.  
     ...
     static double Id =  0.4 ;  // directional intensity
                                // keep Ia, Id >=0, Ia+Id <= 1
     static double Drnth = 0 ;  // lighting direction angle, in degrees
...
//                    skip[n]  = false ;
          ...
          Ia =  0.45 ;  // ambient intensity
          Id =  0.45 ;  // directional intensity
          nth = 37 ;
          nz = 21 ;
          th1 = 0 ;
          dth = 10*Math.PI/180 ;
...
//                    skip[n]  = false ;
     ...
     public double hypDensity(double z, double th) {  // angle in degrees
          ...
          double density = Ia +Id*(
                            0.6*Z2*cosTh*cosDrnth*sinDrnphi 
     ...
     public boolean hypVisible(double z, double th) {  // angle in degrees
          double r = Math.sqrt(1+z*z) ;
          double dotProd =   0.9*r*cosTh*view[0]
                            + r*sinTh*view[1]
                            - z*view[2] ;
          if (dotProd>=0) {
               return true ;
