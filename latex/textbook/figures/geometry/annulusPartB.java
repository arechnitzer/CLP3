...
public class annulusPartB extends Template {

     static {templateClass = new annulusPartB() ; }

     public void setup() {
          filePrefix = "annulusPartB" ; // used as the prefix for any ps or lbl files 
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 1.5 ;      // in inches
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fEnv("psFillGray", 0.8) ;
          double  T = 180*Math.asin(1/2.0)/Math.PI ;
          fEllipticalArc(3, 2, 2, 2, -T, 180+T, FILLED) ;
          fEnv("psFillGray", 1.0) ;
          fDisk(3, 2, 1, 1, FILLED) ;
