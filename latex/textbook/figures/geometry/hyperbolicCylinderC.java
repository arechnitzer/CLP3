...
public class hyperbolicCylinderC extends Template {

     static {templateClass = new hyperbolicCylinderC() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "hyperbolicCylinderC" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0 ;    
          ysize = 2.0 ;  
