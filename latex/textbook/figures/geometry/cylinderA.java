...
public class cylinderA extends Template {

     static {templateClass = new cylinderA() ; }

     public void setup() {
          filePrefix = "cylinderA" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2*0.7 ;      
          ysize = 2*180/120*0.7 ;  
