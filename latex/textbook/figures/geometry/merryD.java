...
public class merryD extends Template {

     static {templateClass = new merryD() ; }
...
//          fLine3d(cx-r+dx, cy, cz, cx+r-dx, cy, cz) ;
          ...
          fArrow3d(cx+xp,cy+yp,cz,  cx+2.5*xp,cy+2.5*yp, cz) ;
          fTeXlabel3d(cx+2.6*xp,cy+2.6*yp, cz, "cc", "$\\vF_{{\\rm cor}}$") ;
