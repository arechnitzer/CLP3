...
public class hyperboloidCC extends Template {

     static {templateClass = new hyperboloidCC() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "hyperboloidCC" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0 ;    
          ysize = 2.0 ;  
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          z0=3 ; 
          double XM = Math.sqrt(-1+z0*z0)/2.0 ;
