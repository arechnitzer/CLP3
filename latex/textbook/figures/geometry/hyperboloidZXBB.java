...
public class hyperboloidZXBB extends Template {

     static {templateClass = new hyperboloidZXBB() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "hyperboloidZXBB" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0 ;    
          ysize = 2.0 ;  
...
//                 0,90,OPEN) ;
          ...
          z0 = 1.02 ; X = 0.5*Math.sqrt(-1+z0*z0) ; Y = Math.sqrt(-1+z0*z0) ;
          fCurve(new circ3d(al, 0.5,   0,0,z0, X,0,0, 0,Y,0),
                 0,90,OPEN) ;
          fTeXlabel3d(0,ym,1-0.1, "tr", "$z=1.02$") ;
