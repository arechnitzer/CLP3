...
public class hyperboloidZX extends Template {

     static {templateClass = new hyperboloidZX() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "hyperboloidZX" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 1.5*8/5 ;    
          ysize = 1.5 ;  
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          z0=2 ;
         fEnv("psFillGray", 0.9) ;
         {double[] xlist = {-3,  -3,  3, 3} ;
          double[] ylist = {-3,   3,  3, -3} ;
          double[] zlist = { z0,   z0,  z0, z0} ;
          ...
          fCurve(new circ3d(al, 0.5,   0,0,2, X,0,0, 0,Y,0),
                 0,360,CLOSED) ;
          fTeXlabel3d(-2.5,ym-0.3,2, "tr", "$z=z_0$") ;
