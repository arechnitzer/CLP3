...
public class rampABC extends Template {

     static {templateClass = new rampABC() ; }
...
//          canvas.append( new fPsWrite("0.7 setgray\n")) ;
          ...
          fLine3d(0,a,0, 0,0,a) ;
          fLine3d(a,0,0, 0,0,a) ;
          fTeXlabel3d(0,0.73*a,0.3*a, "bl", "$F\\!=\\!e^3$") ;
          ...
          fLine3d(0,a,0, 0,0,a) ;
          fLine3d(a,0,0, 0,0,a) ;
          fTeXlabel3d(0,0.75*a,0.3*a, "bl", "$F\\!=\\!e$") ;
          ...
          fLine3d(0,a,0, 0,0,a) ;
          fLine3d(a,0,0, 0,0,a) ;
          fTeXlabel3d(0,0.73*a,0.3*a, "bl", "$F\\!=\\!e^2$") ;
