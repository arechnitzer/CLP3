...
public class spherePlane extends Template {

     static {templateClass = new spherePlane() ; }
...
//          ymax =  90 ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fCurve(new circ3d(proj,   0,0,0, 0,0,r2, r2*xh,r2*yh,0),
                 0,90,OPEN)  ;
          fCurve(new circ3d(proj,   0,0,0, 0,0,r2, r2,0,0),
                 0,90,OPEN)  ;
          fCurve(new circ3d(proj,   0,0,0, r2,0,0, 0,r2,0),
                 0,90,OPEN)  ;
          fCurve(new circ3d(proj,   0,0,0, 0,r2,0, 0,0,r2),
                 0,90,OPEN)  ;
          canvas.append( new fPsWrite("[2.5 2.5] 0.0 setdash\n")) ;
          fLine3d(0,0,0, r2*xh,r2*yh,0) ;
          fLine3d(0,0,0,  0,0,r2) ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          fLine3d(r2*xh,r2*yh,0, rp*xh,rp*yh,0) ;
          fLine3d(0,0,zp, rp*xh,rp*yh,zp) ;
          fLine3d(rp*xh,rp*yh,zp, rp*xh,rp*yh,0) ;
          fTeXlabel3d(1.05*rp*xh,1.05*rp*yh,0, "tl", "$y=x$") ;
          fTeXlabel3d(0.6*r2,-10,r2/2, "cr", "$x^2+y^2+z^2=1$") ;
