...
public class spherA extends Template {

     static {templateClass = new spherA() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fEnv("lineWidth", 1.5) ;
               ...
               fCurve(new circ3d(proj,   0,0,r*zv, r*xv),0,90,OPEN)  ;
          fEnv("lineWidth", 0.5) ;
          fTeXlabel3d(0,0.97*r,0.3*r, "bl", "$F=9$") ;
          ...
          fEnv("lineWidth", 1.5) ;
               ...
               fCurve(new circ3d(proj,   0,0,r*zv, r*xv),0,90,OPEN)  ;
          fEnv("lineWidth", 0.5) ;
//          fTeXlabel3d(0,0.1*r,1.02*r, "bl", "$\\scriptstyle F=1$") ;
          fTeXlabel3d(1.04*r,0.1*r,0, "tl", "$F=1$") ;
          ...
          fEnv("lineWidth", 1.5) ;
               ...
               fCurve(new circ3d(proj,   0,0,r*zv, r*xv),0,90,OPEN)  ;
          fEnv("lineWidth", 0.5) ;
          fTeXlabel3d(0,0.97*r,0.3*r, "bl", "$F=4$") ;
