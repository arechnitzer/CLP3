...
public class area3 extends Template {

     static {templateClass = new area3() ; }
...
//          fEnv("tailHalfWidth", 3) ;
         ...
         fEnv("useColorPs", "true") ;
          fEnv("headHalfWidth", 1.2*1.2) ;
          fEnv("headLength", 6*1.2) ;
         fArrow( 0, 0,    100, 50  ) ;
         fArrow( 0, 0,     50, 100  ) ;
         fArrow( 100, 50, 150, 150  ) ;
         fArrow( 50, 100,  150, 150  ) ;
         fDisk(0,0, 1.5,1.5, FILLED) ;
         fDisk(50,100, 1.5,1.5, FILLED) ;
         fDisk(100,50, 1.5,1.5, FILLED) ;
