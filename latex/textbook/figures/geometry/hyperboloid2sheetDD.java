...
public class hyperboloid2sheetDD extends Template {

     static {templateClass = new hyperboloid2sheetDD() ; }
...
//  General orthogonal projection.  
     ...
     public void setup() {
          filePrefix = "hyperboloid2sheetDD" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0*0.7 ;    
          ysize = 3.0*0.7 ;  
