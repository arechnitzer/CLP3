...
public class spher5 extends Template {

     static {templateClass = new spher5() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d( (r1+r2)*xh/2,(r1+r2)*yh/2-2,-2, "tc", "$\\dee{r}$") ;
          fCurve(new circ3d(al, 0.5,   0,0,0, 0,0,r2, r2*xh,r2*yh,0),
                 phi1,phi2,OPEN)  ;
          fCurve(new circ3d(al, 0.5,   0,0,0, 0,0,r1, r1*xh,r1*yh,0),
                 phi1,phi2,OPEN)  ;
          ...
          fCurve(new circ3d(al, 0.5,   0,0,r1*zv, r1*xv),th1,th2,OPEN)  ;
          xv = Math.sin(phi1*Math.PI/180);
          zv = Math.cos(phi1*Math.PI/180);
          fCurve(new circ3d(al, 0.5,   0,0,r2*zv, r2*xv),th1,th2,OPEN)  ;
          fCurve(new circ3d(al, 0.5,   0,0,r1*zv, r1*xv),th1,th2,OPEN)  ;
          ...
          fTeXlabel3d(r2*xh*xv,r2*yh*xv,r2*zv+30, "bc","$r\\sin\\theta\\,\\dee{\\phi}$") ;


          
          fTeXlabel(30,-40, "tc", "volume element $\\dee{V}=r^2\\sin\\theta\\ \\dee{r}\\,\\dee{\\theta}\\,\\dee{\\phi}$") ;
