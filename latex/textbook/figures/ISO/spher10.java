...
public class spher10 extends Template {

     static {templateClass = new spher10() ; }
...
//          double phi2 = 70 ;
          ...
          fTeXlabel3d(r2*xh*xv/2,r2*yh*xv/2-31,r2*zv-7, "cr", "$r\\sin\\theta$") ;
          fTeXlabel(5,8, "bc", "$\\theta$") ;
          fTeXlabel(21,7, "bc", "$r$") ;
          fTeXlabel(30,36.5, "bc", "$\\dee{\\phi}$") ;
          fEnv("lineWidth", 0.6) ;
...
//          fLine3d(0,0,0, r2*xh,r2*yh,0) ;
          ...
          canvas.append( new fPsWrite("0.7 setgray\n")) ;
          fEnv("lineWidth", 0.6) ;
          fCurve(new circ3d(al, 0.5,   0,0,r2*xh, r2*yh),0,90,OPEN)  ;
