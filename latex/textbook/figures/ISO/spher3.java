...
public class spher3 extends Template {

     static {templateClass = new spher3() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel3d(30*0.9, 10*0.9 ,0,  "tc", "$\\phi$") ;          
          fTeXlabel(12,-33, "tc", "surface of constant $\\phi$") ;
          fTeXlabel(12,-51, "tc", "(half a plane)") ;
