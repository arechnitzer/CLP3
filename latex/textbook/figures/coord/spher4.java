...
public class spher4 extends Template {

     static {templateClass = new spher4() ; }
...
//          double z = R*Math.cos(phi) ;
          ...
          fEnv("lineWidth", 1.5) ;
          fCurve(new circ3d(proj,   0,0,z, Rx,0,0, 0,Ry,0),  0,90,OPEN)  ;
          fLine3d(0,0,0, Rx,0,z) ;
          fLine3d(0,0,0, 0,Ry,z) ;

          fTeXlabel3d(0, 8 ,30,  "tc", "$\\varphi$") ;          
          fTeXlabel(12,-33, "tc", "surface of constant $\\varphi$") ;
          fTeXlabel(12,-51, "tc", "(a cone)") ;
