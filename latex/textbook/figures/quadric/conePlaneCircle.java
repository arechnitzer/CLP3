...
public class conePlaneCircle extends Template {

     static {templateClass = new conePlaneCircle() ; }
...
//          fTeXlabel3d(xm,-1,-1, "tr", "$x$") ;
          ...
          fTeXlabel3d(0, 0, -H-1.1, "bc", "circle") ;
          fEnv("psFillGray", 0.8) ;
          fCurve(new circ3d(proj, 0,0,-h, h,0,0, 0,h,0), 0,360,FILLED)  ;
          ...
          fEnv("lineWidth", 1.0) ;
          fCurve(new circ3d(proj, 0,0,-h, h,0,0, 0,h,0), -90,90,OPEN)  ;
