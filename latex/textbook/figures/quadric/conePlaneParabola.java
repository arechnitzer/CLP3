...
public class conePlaneParabola extends Template {

     static {templateClass = new conePlaneParabola() ; }
...
//          fTeXlabel3d(xm,-1,-1, "tr", "$x$") ;
          ...
          double H, h, th, x, y, y0, x0 ;
          H = 2 ;
          h = 1.3 ;
          y0 = 1.3 ;
          x0 = Math.sqrt(2*y0*H-y0*y0) ;

          fTeXlabel3d(0, 0, -H-1.1, "bc", "parabola") ;
          fEnv("psFillGray", 0.8) ;
          fCurve(new para3d(proj, y0) , -x0, x0,FILLED)  ;
          ...
          fCurve(new para3d(proj, y0) , -x0, 0,OPEN)  ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          fCurve(new para3d(proj, y0) , 0, x0,OPEN)  ;
...
class para3d implements S2V {
   ...
   public para3d(double[][] proj, double y0) {
        this.proj = proj ;
        this.y0 = y0 ;
   }
