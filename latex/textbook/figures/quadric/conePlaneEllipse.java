...
public class conePlaneEllipse extends Template {

     static {templateClass = new conePlaneEllipse() ; }
...
//          fTeXlabel3d(xm,-1,-1, "tr", "$x$") ;
          ...
          double H, h, th, x, y, z0, a ;
          H = 2 ;
          h = 1.3 ;
          z0 = -1.3 ;
          a = 0.25 ;

          fTeXlabel3d(0, 0, -H-1.1, "bc", "ellipse") ;

          fEnv("psFillGray", 0.8) ;
          fCurve(new ellipse3d(proj, a, z0) , 0, 360,FILLED)  ;
          ...
          fCurve(new ellipse3d(proj, a, z0) , 90, 270, OPEN)  ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          fCurve(new ellipse3d(proj, a, z0) , -90, 90, OPEN)  ;
...
class ellipse3d implements S2V {

     double[][] proj = { {1, 0, 0},   { 0,  1, 0}   };
     double z0 = 1.3 ;
     double a = 0.5 ;
     double rx = Math.sqrt(z0*z0/(1-a*a)) ;
     double ry = z0/(1-a*a) ;
     double cy = a*z0/(1-a*a) ;
          

   public ellipse3d(double[][] proj, double a, double z0) {
        this.proj = proj ;
        this.z0 = z0 ;
        this.a = a ;
        rx = Math.sqrt(z0*z0/(1-a*a)) ;
        ry = z0/(1-a*a) ;
        cy = a*z0/(1-a*a) ;
   }
     ...
     public double[] map(double t) {
          double[] out = {0,0} ;
          double x = rx*Math.cos(t*Math.PI/180.0) ;
          double y = cy+ry*Math.sin(t*Math.PI/180.0) ;
          double z = a*y+z0 ;
