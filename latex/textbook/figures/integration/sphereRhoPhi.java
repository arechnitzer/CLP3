...
public class sphereRhoPhi extends Template {

     static {templateClass = new sphereRhoPhi() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          canvas.append( new fPsWrite("[2.8 2.8] 0.0 setdash\n")) ;
          fLine3d(0,0,r, 0,0,0) ;
          fLine3d(0,r,0, 0,0,0) ;
          fLine3d(r,0,0, 0,0,0) ;
          fLine3d(0,0,Z, Rx,0,Z) ;
          fLine3d(0,0,Z, 0,Ry,Z) ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          fTeXlabel3d(0,0,zm+3, "cb", "$z$") ;
          fTeXlabel3d(0,ym+3,0, "cl", "$y$") ;
          fTeXlabel3d(xm,-1,-1, "tr", "$x$") ;
          fCurve(new circ3d(proj,   0,0,0, 0,0,15, 0,15,0),  0,phiDeg,OPEN)  ;
          ...
          fCurve(new circ3d(proj,   0,0,0, 0,0,r, 0,r,0),  0,90,OPEN)  ;
          fCurve(new circ3d(proj,   0,0,0, r,0,0, 0,r,0),  0,90,OPEN)  ;
          canvas.append( new fPsWrite("[2.8 2.8] 0.0 setdash\n")) ;
          fLine3d(0,0,0, Rx,0,Z) ;
          fLine3d(0,0,0, 0,Ry,Z) ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;


          canvas.append( new fPsWrite(Red+"\n")) ;
          fEnv("lineWidth", 1.5) ;
          fCurve(new circ3d(proj,   0,0,Z, Rx,0,0, 0,Ry,0),
                 0,90,OPEN)  ;


          fTeXlabel3d(0, 8 ,22,  "tc", "$\\scriptstyle\\varphi$") ;                    
          fTeXlabel3d(0,24, 24, "tl", "$\\rho$") ;

          fTeXlabel3d(0, 20 ,-30,  "tc", "circle of intersection") ;          
