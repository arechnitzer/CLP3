...
public class sphereThPhi extends Template {

     static {templateClass = new sphereThPhi() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fCurve(new circ3d(proj,   0,0,0, 0,0,r, r,0,0),  0,phiDeg,OPEN)  ;
          ...
          fTeXlabel3d(0, -4 ,25,  "tc", "$\\scriptstyle\\varphi$") ;          
