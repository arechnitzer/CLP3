...
public class sphereCyl2a extends Template {

     static {templateClass = new sphereCyl2a() ; }
...
//               canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          ...
          xv = Math.sin(20*Math.PI/180);
          zv = Math.cos(20*Math.PI/180);
          fTeXlabel3d(0,r*xv+2,r*zv, "bl", "$r^2+z^2=1$") ;  
