...
public class sphereCyl2 extends Template {

     static {templateClass = new sphereCyl2() ; }
...
//               canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          ...
          canvas.append( new fPsWrite(Black+"\n")) ;
               fCurve(new circ3d(proj,   0,0,z1 , 30),th1,th2,OPEN)  ;
          fEnv("headHalfWidth", 2.0*1.2) ;
          fEnv("headLength", 6.0*1.2) ;
          fArrow3d(0, 1.3*r1, z1+40,  40*Math.cos( (0.5*th1+0.5*th2)*Math.PI/180 ), 
                                  40*Math.sin( (0.5*th1+0.5*th2)*Math.PI/180 ),z1) ;
          fTeXlabel3d(0, 1.3*r1+1, z1+41, "cl", "$\\dee{\\theta}$") ; 
