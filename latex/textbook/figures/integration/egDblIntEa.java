...
public class egDblIntEa extends Template {

     static {templateClass = new egDblIntEa() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fEnv("psFillGray", 0.9) ;
          fCurve(new circ3d(proj,   0,0,0, r),0,360,FILLED)  ;
...
//             fPolygon3d(xlist, ylist, zlist, 4, FILLED) ; }
          ...
          fTeXlabel3d(0,ym/2.0,zm-5, "tl", "$z=1-3x^2-2y^2$") ;
          fTeXlabel3d(xm/2.0+30,ym/2.0,0, "tl", "$3x^2+2y^2=1$") ;
          fTeXlabel3d(0,-20,0, "tl", "$\\cR$") ;
