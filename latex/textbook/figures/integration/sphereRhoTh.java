...
public class sphereRhoTh extends Template {

     static {templateClass = new sphereRhoTh() ; }
...
//          fTeXlabel(5,8, "bc", "$\\scriptstyle\\varphi$") ;
          fTeXlabel(21,9, "bc", "$\\scriptstyle\\dee{\\varphi}$") ;
