...
public class reflDo extends Template {

     static {templateClass = new reflDo() ; }

     public void setup() {
          filePrefix = "reflDo" ; // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
     ...
     public  void prepareFigure(Figure canvas) {
         String White  = "1 1 1 setrgbcolor  " ;
          ...
          fTeXlabel(-25, -45, "cb", "$\\mathcal{R}_o$") ;
          ...
          fTeXlabel(0, ymin-3, "tc", "$\\mathcal{R}_o=$reflection of $\\mathcal{R}$ across the origin") ;
