...
public class iceCream2b extends Template {

     static {templateClass = new iceCream2b() ; }

     public void setup() {
          filePrefix = "iceCream2b" ;   
          outputPsFile = true ;
          outputLblFile = true ;
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          double th2 = 90-4*dth ; double th2Rad = th2*Math.PI/180 ;
          double th1 = 90-5*dth ; double th1Rad = th1*Math.PI/180 ;
          fEnv("psFillGray", 0.9) ;
          ...
          th1 = 90-dth ; th1Rad = th1*Math.PI/180 ;
          fEnv("psFillGray", 0.7) ;
          fEllipticalArc(0,0, a,a, th1, th2, WEDGE+FILLED) ;
          fEllipticalArc(0,0, a,a,  th1, th2, OPEN) ;
          fLine(0,0, a*Math.cos(th1Rad),a*Math.sin(th1Rad)) ;
