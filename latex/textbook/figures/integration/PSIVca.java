...
public class PSIVca extends Template {

     static {templateClass = new PSIVca() ; }

     public void setup() {
          filePrefix = "PSIVca" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 1.2 ;      // in inches
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          { double[] xlist = { 0, 0, 2, 2, 1} ;
            double[] ylist = { 1, 2, 2, 0, 0} ;
