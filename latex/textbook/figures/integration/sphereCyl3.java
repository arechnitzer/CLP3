...
public class sphereCyl3 extends Template {

     static {templateClass = new sphereCyl3() ; }
...
//          fEnv("useColorPs", "true") ;
          ...
          fEnv("psFillGray", 0.6) ;
          fCurve(new circ3d(proj,   0,0,z1 , r1),th1,th2,FILLED)  ;
...
//               canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          ...
          canvas.append( new fPsWrite(Black+"\n")) ;
               double th3 = 1.13*th2 ; double th3Rad =th3*Math.PI/180 ;
               double cth3 = Math.cos(th3Rad) ; double sth3 = Math.sin(th3Rad) ;
               fLine3d(R*cth3,R*sth3,z1, RR*cth3,RR*sth3, z1 )  ;
          fEnv("headHalfWidth", 2.0*1.2) ;
          fEnv("headLength", 6.0*1.2) ;
          fArrow3d(0, 1.3*r1, z1+40, (0.5*R+0.5*RR)*cth3,(0.5*R+0.5*RR)*sth3+1,z1+1) ;
          fTeXlabel3d(0, 1.3*r1+1, z1+41, "cl", "$\\dee{r}$") ; 
