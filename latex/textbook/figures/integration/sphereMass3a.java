...
public class sphereMass3a extends Template {

     static {templateClass = new sphereMass3a() ; }
...
//          fEnv("useColorPs", "true") ;
          ...
          {  double[] xlist = {x1, x1, x2, x2} ;
             ...
             double[] zlist = {z1, z1, z1, z1} ;
             fPolygon3d(xlist, ylist, zlist, 4, FILLED) ; }
          {  double[] xlist ={Math.sqrt(r*r-z1*z1-y1*y1)-12,Math.sqrt(r*r-z1*z1-y2*y2)-12,
                         Math.sqrt(r*r-z1*z1-y2*y2),Math.sqrt(r*r-z1*z1-y1*y1)} ;
             double[] ylist = {y1, y2, y2, y1} ;
             double[] zlist = {z1, z1, z1, z1} ;
             fPolygon3d(xlist, ylist, zlist, 4, FILLED) ; }
...
//          fTeXlabel3d(0,r*xv+2,r*zv, "bl", "$x=\\sqrt{1-y^2-z^2}$") ;  

          fEnv("lineWidth", 0.5) ;
          canvas.append( new fPsWrite(Black+"\n")) ;
          double y12 = 0.5*y1+0.5*y2 ;
          fArrow3d(0,r1-5,z1+40,  0,y12,z1+1) ;
          fTeXlabel3d(0,r1-4,z1+42, "cl", "$(0,y,z)$") ; 
          fArrow3d(r1,0.5*r1,-10,  Math.sqrt(r*r-z1*z1-y12*y12),y12,z2-1) ;
          fTeXlabel3d(r1,0.5*r1+1,-10, "cl", 
                       "$\\scriptstyle(\\,\\sqrt{1-y^2-z^2}\\,,\\,y\\,,\\,z)$") ; 
