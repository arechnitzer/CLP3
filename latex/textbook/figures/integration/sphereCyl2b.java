...
public class sphereCyl2b extends Template {

     static {templateClass = new sphereCyl2b() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          double z1 = 30 ;
          double z2 = 23 ;
          double th1 = 0 ; double th1Rad = th1*Math.PI/180 ;
          double th2 = 13 ; double th2Rad = th2*Math.PI/180 ;
...
//               canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          ...
          th1 = 90-18 ; th1Rad = th1*Math.PI/180 ;
          th2 = 90 ;  th2Rad = th2*Math.PI/180 ;
          thm = 0.5*th1+0.5*th2 ; thmRad = thm*Math.PI/180 ;
          x1 = r1*Math.cos(th1Rad) ;   y1 = r1*Math.sin(th1Rad) ;
          x2 = r1*Math.cos(th2Rad) ;   y2 = r1*Math.sin(th2Rad) ;
          x12 = r1*Math.cos(thmRad) ;  y12 = r1*Math.sin(thmRad) ;
          ...
          fArrow3d(0,r1,z1+30,  0,r1/2,z1+1) ;
          fTeXlabel3d(0,r1+2,z1+31, "cl", "$\\theta=\\pi/2$") ; 
          fArrow3d(r1,0.8*r1, -10,       0.4*r1, 0, z1-1) ;
          fTeXlabel3d(r1,0.8*r1+2, -10, "cl", "$\\theta=0$") ; 
