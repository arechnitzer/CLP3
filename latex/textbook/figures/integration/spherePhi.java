...
public class spherePhi extends Template {

     static {templateClass = new spherePhi() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fCurve(new circ3d(proj,   0,0,0, 0,0,r, 0,r,0),  0,phiDeg-5,OPEN)  ;
          ...
          fLine3d(0,0,0, 0,0,50) ;
          canvas.append( new fPsWrite("[ ] 0 setdash\n")) ;
          fLine3d(0,0,52, 0,0,z) ;

          fTeXlabel3d(0, 9 ,28,  "tc", "$\\scriptstyle\\varphi$") ;          
          ...
          fTeXlabel3d(0, 10 ,-30,  "tc", "cone of fixed $\\varphi$") ;          
