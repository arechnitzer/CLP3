...
public class cos2Agraph extends Template {

     static {templateClass = new cos2Agraph() ; }

     public void setup() {
          filePrefix = "cos2Agraph" ;    // used as the prefix for ps and lbl files 
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.5 ;    
          ysize = 1.2 ;   
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fCurve("y=cos(x)*cos(x)", 0, 0, 0.5*pi,  FILLED) ;
          {double[] xlist = {pi/2, pi/4, pi/8, 0, 0} ;
           double[] ylist =  {0  ,     SS,     S, 1, 0} ;
           fPolygon(xlist, ylist, 5, FILLED) ;} 
          ...
          fEnv("lineWidth", 1.0) ;
          fTeXlabel(pi, 1.05, "bc", "$y=\\cos^2\\theta$") ;
