...
public class sin2Agraph extends Template {

     static {templateClass = new sin2Agraph() ; }

     public void setup() {
          filePrefix = "sin2Agraph" ;    // used as the prefix for ps and lbl files 
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.5 ;    
          ysize = 1.2 ;   
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fCurve("y=sin(x)*sin(x)", 0, 0, 0.5*pi, FILLED) ;
          ...
          fEnv("lineWidth", 1.0) ;
          fTeXlabel(0.5*pi, 1.05, "bc", "$y=\\sin^2\\theta$") ;
