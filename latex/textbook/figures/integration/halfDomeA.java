...
public class halfDomeA extends Template {

     static {templateClass = new halfDomeA() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fEnv("psFillGray", 0.9) ;
          fCurve(new circ3d(proj,   0,0,0, r),90,270,FILLED)  ;
...
//             fPolygon3d(xlist, ylist, zlist, 4, FILLED) ; }
          ...
          fTeXlabel3d(0,ym/2.0,zm-5, "tl", "$x^2+y^2+z^2=a^2$") ;
//          fTeXlabel3d(xm/2.0+30,ym/2.0,0, "tl", "$3x^2+2y^2=1$") ;
          fTeXlabel3d(-60,10,0, "tl", "$\\cR$") ;
...
//          fEnv("useColorPs", "true") ;
          ...
          th = 90 ;
               ...
               fCurve(new circ3d(proj,   0,0,0, r*xh,r*yh,0, 0,0,r),
                       0,180,OPEN)  ;
          ...
          fCurve(new circ3d(proj,   0,0,r*zv, r*xv),90,270,OPEN)  ;
