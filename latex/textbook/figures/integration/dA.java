...
public class dA extends Template {

     static {templateClass = new dA() ; }

     public void setup() {
          filePrefix = "dA" ;    // used as the prefix for any ps, lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 1.0;      // in inches
          ysize = 1.0 ;   // in inches
...
//          fTeXlabel(x1,y1, "br", "$P_0=\\vr(u_0,v_0)$") ;
          ...
          fTeXlabel(x2-0.1,y2+0.5, "br", "$P_1$") ;
          fTeXlabel(x3-0.5,y3+0.5, "br", "$P_3$") ;
          fTeXlabel(x4-0.5,y4+0.1, "br", "$P_2$") ;

          fTeXlabel(9.2,y2-0.7, "cl", 
                  "${\\scriptstyle\\atp{u{\\rm\\ varying }}{v=v_0}}$");
          fTeXlabel(9.7,y3-1.1, "cl", 
                  "${\\scriptstyle\\atp{u{\\rm\\ varying }}{v=v_0+\\dee{v}}}$");
          fTeXlabel(x3-1,10.4, "cb", 
                  "${\\scriptstyle\\atp{u=u_0+\\dee{u}}{v{\\rm\\ varying }}}$");
          fTeXlabel(x4-2,10.4, "cb", 
                  "${\\scriptstyle\\atp{u=u_0}{v{\\rm\\ varying }}}$");
     }
}
