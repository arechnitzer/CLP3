...
public class appleCoreB extends Template {

     static {templateClass = new appleCoreB() ; }
...
//          fCurve(new circ3d(proj,   0,0,r*zv, r*xv),0,90,OPEN)  ;
          ...
          {  double[] xlist = {0,r,r/sq2,    0} ;
             double[] ylist = {0,   0,r/sq2, r} ;
...
//          fEnv("useColorPs", "true") ;
          ...
          fCurve(new circ3d(proj,   0,0,0   , r),0,90,OPEN)  ;
          fLine3d(r,0,0,  r*xv,0,0) ;
          fLine3d(0,r,0,  0,r*xv,0) ;
          fLine3d(r*xv,0,0,  r*xv,0,r*zv) ;
          fLine3d(0,r*xv,0,  0,r*xv,r*zv) ;

          canvas.append( new fPsWrite(Black+"\n")) ;
          fEnv("lineWidth", 0.5) ;
          fArrow3d(0,0.5*r*xv-3,4, 0,1,4) ;
          fArrow3d(0,0.5*r*xv+3,4, 0,r*xv-1,4) ;


          fTeXlabel3d(0,0.5*r*xv,2, "bc", "$b$") ;
