...
public class iceCream extends Template {
     ...
     static {templateClass = new iceCream() ; }
...
//          } 
         ...
         fLine3d(0,0,0, r*xh*Math.sin(phi*Math.PI/180), 
          ...
          xh = Math.cos(90*Math.PI/180);
          yh = Math.sin(90*Math.PI/180);
          fCurve(new circ3d(proj,   0,0,0, 0,0,rr, rr*xh,rr*yh,0),
                 0,phi,OPEN)  ;
          fLine3d(0,0,r*zv, 0, r*xv, r*zv) ;
          fLine3d(0,0,r*zv, r*xv, 0, r*zv) ;


          fTeXlabel3d(0, 8, 1.2*rr, "cb", "$\\beta$") ;
          fTeXlabel3d(0.5*r*xh*Math.sin(phi*Math.PI/180), 
                         0.5*r*yh*Math.sin(phi*Math.PI/180)+3, 0.5*r*zv+4, "lt", 
                         "$\\varphi=\\be$") ;    
          fTeXlabel3d(0.5*r*xh*Math.sin(phi*Math.PI/180), 
                         0.5*r*yh*Math.sin(phi*Math.PI/180)+5, r*zv+15, "lb", 
                         "$\\rho=a$") ;    
