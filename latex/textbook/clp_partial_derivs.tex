...
we evaluate the derivative by applying the definition
\begin{align*}
...
the direction vector $\vv$ points into the solid. The angle between $\vv$ and the outward pointing normal $\vn$ is greater than $90^\circ$, so that the dot product
$\vv\cdot\vn<0$. But
\item
at the point $(x',y',z')$ where the ray leaves the solid, which is a 
hidden point, the direction vector $\vv$ points out of the solid. The angle between $\vv$ and the outward pointing normal $\vn'$ is less than $90^\circ$, 
so that the dot product $\vv\cdot\vn'>0$.
\end{itemize}
\end{itemize}
