...
public class cylB extends Template {

     static {templateClass = new cylB() ; }
...
//          canvas.append( new fPsWrite("0.7 setgray\n")) ;
          ...
          y = 0.75*Y ;
          fLine3d(0,y,0, 0,y,zm) ;
          fLine3d(0,y,0, xm,y,0) ;
          canvas.append( new fPsWrite(Pink+"\n")) ;
          r = 65 ;
          fEnv("lineWidth", 1.5) ;
               fCurve(new circ3d(proj,   0,y,0, 0,0,r, r,0,0),   0,90,OPEN)  ;
          fEnv("lineWidth", 0.5) ;
          fTeXlabel3d(0.2*r,y-4,0.8*r, "br", "$F=C$") ;
          fTeXlabel3d(0,y+3,zm, "tl", "$y=y_0$") ;
