...
public class hyperbolicCylinderB extends Template {

     static {templateClass = new hyperbolicCylinderB() ; }
     static double x0 = 100 ;
     static double x1 =   0 ;

     public void setup() {
          filePrefix = "hyperbolicCylinderB" ;  
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.0 ;    
          ysize = 2.0 ;  
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fLine3d(2.5,0,0, 2.5,0,zm) ;
          fLine3d(5,0,0, 5,0,zm) ;
          fLine3d(0,0,0, 0,ym,0) ;
          fLine3d(2.5,0,0, 2.5,ym,0) ;
          fLine3d(5,0,0, 5,ym,0) ;
