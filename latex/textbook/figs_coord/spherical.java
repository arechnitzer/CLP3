...
//          double zm = 70 ;
          ...
          fTeXlabel3d(1.05*0.56*P[0], 1.05*0.16*P[1], 0, "cl", "$\\theta$") ;
          fTeXlabel3d(0.8*0.56*P[0], 0.8*0.28*P[1], 0.8*0.43*P[2], "bl", "$\\varphi$") ;
          ...
          fTeXlabel3d(P[0]/2, P[1]/2+2, P[2]/2-2, "cl", "$\\rho$") ;
          fTeXlabel3d(0.4*P[0], 0.4*P[1], P[2]+2, "bl", "$\\rho\\sin\\varphi$") ;
          fTeXlabel3d(0, -1, P[2]/2, "cr", "$\\rho\\cos\\varphi$") ;
          fTeXlabel3d(P[0], 0.45*P[1], -2, "ct", "$\\rho\\sin\\varphi\\sin\\theta$") ;
