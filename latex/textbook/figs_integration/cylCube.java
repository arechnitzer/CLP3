...
public class cylCube extends Template {

     static {templateClass = new cylCube() ; }
...
//          double x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          fTeXlabel(r1*Math.cos(th2*Math.PI/180)/2*x0+r1*Math.sin(th2*Math.PI/180)/2,
                 r1*Math.cos(th2*Math.PI/180)*x1+z+6, "bc", "$r$") ;
          fTeXlabel(r1*Math.cos(th2*Math.PI/180)*x0+r1*Math.sin(th2*Math.PI/180)+22,
                 r1*Math.cos(th2*Math.PI/180)*x1+z+4, "bc", "$\\dee{r}$") ;
          ...
          fTeXlabel(r2*Math.cos(th2*Math.PI/180)*x0+r2*Math.sin(th2*Math.PI/180)-30,
                r2*Math.cos(th2*Math.PI/180)*x1-13, "lc", "$r\\,\\dee{\\theta}$") ;
...
//          fTeXlabel(55,-35, "tc", "volume element $\\dee{V}=r\\,\\dee{r}\\,\\dee{\\theta}\\,\\dee{z}$") ;
