...
public class appleCoreB3b extends Template {

     static {templateClass = new appleCoreB3b() ; }

     public void setup() {
          filePrefix = "appleCoreB3b" ;   
          outputPsFile = true ;
          outputLblFile = true ;
