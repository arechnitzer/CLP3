...
public class volSliceB extends Template {

     static {templateClass = new volSliceB() ; }

     public void setup() {
          filePrefix = "volSliceB" ;
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 2.5 ;   
          ysize = 2.5*0.8 ;   
     ...
     public  void prepareFigure(Figure canvas) {
          ...
          fTeXlabel(-0.1,  ry+0.2, "br", "$x=L(y)$") ;
          fTeXlabel(-0.1, -ry-0.2, "tr", "$x=R(y)$") ;
          fTeXlabel(xmin, -0.5*(yst+ysb), "cl", "$\\scriptstyle\\dee{x}$") ;
          fTeXlabel(x+0.03, ymax, "tc", "$\\scriptstyle\\dee{y}$") ;
          fTeXlabel( rx,  2.1, "cb", "$y = d$") ;
          fTeXlabel(-rx,  2.2, "cb", "$y = c$") ;
