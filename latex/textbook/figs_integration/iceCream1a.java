...
public class iceCream1a extends Template {

     static {templateClass = new iceCream1a() ; }
...
//          x1 = Math.sin(Math.PI*(1+al/180)) ;
          ...
          for ( int i=0; i <= nth ; i++ ) {
               ...
               fCurve(new circ3d(proj,   0,0,0, 0,0,r, r*xh,r*yh,0),
                      0,phi,OPEN)  ;
               fLine3d(0,0,0, r*xh*Math.sin(phi*Math.PI/180), 
                              r*yh*Math.sin(phi*Math.PI/180), r*zv) ;
               fLine3d(0,0,r*zv, r*xh*Math.sin(phi*Math.PI/180), 
                              r*yh*Math.sin(phi*Math.PI/180), r*zv) ;
               th += dth ;
          } 
          ...
          canvas.append( new fPsWrite("0.7 setgray\n")) ;
          fEnv("lineWidth", 1.0) ;
          xh = Math.cos(0*Math.PI/180);
          yh = Math.sin(0*Math.PI/180);
          fCurve(new circ3d(proj,   0,0,0, 0,0,r, r*xh,r*yh,0),
                 0,phi,OPEN)  ;
          fLine3d(0,0,0, r*xh*Math.sin(phi*Math.PI/180), 
                              r*yh*Math.sin(phi*Math.PI/180), r*zv) ;
          ...
          xh = Math.cos(90*Math.PI/180);
          yh = Math.sin(90*Math.PI/180);
          fCurve(new circ3d(proj,   0,0,0, 0,0,r, r*xh,r*yh,0),
                 0,phi,OPEN)  ;
         fLine3d(0,0,0, r*xh*Math.sin(phi*Math.PI/180), 
                              r*yh*Math.sin(phi*Math.PI/180), r*zv) ;
...
//          canvas.append( new fPsWrite(Black+"\n")) ;
          ...
          fEnv("lineWidth", 0.8) ;
               ...
               fLine3d(0,0,r*zv, r*xh*Math.sin(phi*Math.PI/180), 
                              r*yh*Math.sin(phi*Math.PI/180), r*zv) ;
               fLine3d(0,0,0, 0,0,r) ;
               fCurve(new circ3d(proj,   0,0,r*zv, r*xv),0*dth,1*dth,OPEN)  ;
               ...
               fLine3d(0,0,r*zv, r*xh*Math.sin(phi*Math.PI/180), 
                              r*yh*Math.sin(phi*Math.PI/180), r*zv) ;
               fLine3d(0,0,0, 0,0,r) ;
               fCurve(new circ3d(proj,   0,0,r*zv, r*xv),5*dth,6*dth,OPEN)  ;
