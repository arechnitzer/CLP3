...
public class comPolarA extends Template {

     static {templateClass = new comPolarA() ; }

     public void setup() {
          filePrefix = "comPolarA" ;    // used as the prefix for any ps or lbl files written
          outputPsFile = true ;
          outputLblFile = true ;
          xsize = 6*0.3 ;      // in inches
